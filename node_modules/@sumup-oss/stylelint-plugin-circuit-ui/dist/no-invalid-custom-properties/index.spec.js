...
testRule({
    ...
    accept: [
        ...
        background: linear-gradient(var(--cui-bg-normal), var(--cui-bg-highlight));
            ...
            description: 'Allow valid custom properties prefixed with "--cui-" in complex style rules',
        },
    ],
    reject: [
        {
        ...
        background: linear-gradient(var(--cui-bg-normal), var(--cui-invalid));
            ...
            description: 'Disallow invalid custom properties prefixed with "--cui-" in complex style rules',
            message: messages.invalid('--cui-invalid'),
            line: 2,
            column: 9,
            endLine: 2,
        ...
        background: linear-gradient(var(--cui-invalid), var(--cui-bg-invalid));
            ...
            description: 'Disallow multiple invalid custom properties prefixed with "--cui-" in complex style rules',
            message: messages.invalid('--cui-invalid'),
            line: 2,
            column: 9,
            endLine: 2,
