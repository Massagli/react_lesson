...
const DEPRECATED_CUSTOM_PROPERTIES = schema.filter(({ deprecation }) => Boolean(deprecation));
...
export const messages = stylelint.utils.ruleMessages(ruleName, {
    deprecated: (name, replacement) => `The \`${name}\` custom property has been deprecated. Use the \`${replacement}\` custom property instead.`,
});
const rule = (enabled, _options, context) => (root, result) => {
...
export const noDeprecatedCustomProperties = stylelint.createPlugin(ruleName, rule);
