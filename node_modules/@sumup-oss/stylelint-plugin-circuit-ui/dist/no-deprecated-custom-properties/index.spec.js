...
testRule({
    ...
    reject: [
        ...
        font-size: var(--cui-headline-l-font-size);
            ...
            message: messages.deprecated('--cui-typography-headline-one-font-size', '--cui-headline-l-font-size'),
            line: 2,
            column: 9,
            endLine: 2,
            endColumn: 65,
        ...
        margin-bottom: calc(var(--cui-spacings-bit) - var(--cui-headline-l-line-height));
            ...
            description: 'Disallow deprecated custom properties in complex style rules',
            message: messages.deprecated('--cui-typography-headline-one-line-height', '--cui-headline-l-line-height'),
            line: 2,
            column: 9,
            endLine: 2,
            endColumn: 103,
        ...
        margin-bottom: calc(var(--cui-spacings-bit) - var(--cui-headline-l-line-height) - var(--cui-headline-m-line-height));
            ...
            description: 'Disallow multiple deprecated custom properties in complex style rules',
            warnings: [
                {
                    message: messages.deprecated('--cui-typography-headline-one-line-height', '--cui-headline-l-line-height'),
                    line: 2,
                ...
                {
                    message: messages.deprecated('--cui-typography-headline-two-line-height', '--cui-headline-m-line-height'),
                    line: 2,
                    column: 9,
                    endLine: 2,
                    endColumn: 152,
