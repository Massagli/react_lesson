 ...
 */
import type { FormattableDate, FormattableDateTime, FormattableTime, Locale } from '../../types/index.js';
import { isDateTimeFormatSupported, isDateTimeFormatToPartsSupported } from './intl.js';
 ...
 * @category Date & Time
 */
export declare const formatDateTime: (date: FormattableDateTime, locales?: Locale | Locale[], options?: Intl.DateTimeFormatOptions) => string;
/**
 * Formats a `Date` with support for various
 ...
 * @category Date & Time
 */
export declare function formatDate(date: FormattableDate, // in UTC
locales?: Locale | Locale[], dateStyle?: Intl.DateTimeFormatOptions['dateStyle']): string;
/**
 * Formats a `Date` with support for various
 ...
 * @category Date & Time
 */
export declare function formatTime(date: FormattableTime, // in UTC
locales?: Locale | Locale[], timeStyle?: Intl.DateTimeFormatOptions['timeStyle']): string;
/**
 ...
 * @category Date & Time
 */
export declare const formatDateTimeToParts: (date: FormattableDateTime, locales?: Locale | Locale[], options?: Intl.DateTimeFormatOptions) => (Intl.DateTimeFormatPart | {
    type: "date";
    value: string;
})[];
/**
 ...
 * @category Date & Time
 */
export declare const resolveDateTimeFormat: (locales?: Locale | Locale[], options?: Intl.DateTimeFormatOptions) => null | Intl.ResolvedDateTimeFormatOptions;
