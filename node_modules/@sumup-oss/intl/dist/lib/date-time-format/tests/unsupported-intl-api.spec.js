...
import { formatDateTime, formatDateTimeToParts, resolveDateTimeFormat, } from '../index.js';
import { dates, datetimes, times } from './shared.js';
vi.mock('../intl', async () => {
    const intl = await vi.importActual('../intl');
    return Object.assign(Object.assign({}, intl), { isDateTimeFormatSupported: false, isDateTimeFormatToPartsSupported: false });
});
const locale = 'xx-XX';
