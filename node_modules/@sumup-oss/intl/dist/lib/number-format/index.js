...
import { isNumberFormatSupported, isNumberFormatToPartsSupported, getNumberFormat, } from './intl.js';
...
function formatNumberFactory(getOptions) {
    if (!isNumberFormatSupported) {
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        return (value, _locales, ..._args) => value.toLocaleString();
    }
 ...
 * @category Currency
 */
export const formatCurrencyToParts = formatNumberToPartsFactory(getCurrencyOptions);
/* eslint-enable no-irregular-whitespace */
function formatNumberToPartsFactory(getOptions) {
    if (!isNumberFormatToPartsSupported) {
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        return (value, _locales, ..._args) => [
 ...
 * @category Currency
 */
export const resolveCurrencyFormat = resolveNumberFormatFactory(getCurrencyOptions);
const TEST_VALUE = 1001001001.11111;
function resolveNumberFormatFactory(getOptions) {
    if (!isNumberFormatToPartsSupported) {
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    return (locales, ...args) => {
        ...
        if (options.style === 'currency') {
            ...
            const currencyIndex = findIndex(parts, (part) => part.type === 'currency');
            const currencyPosition = currencyIndex === 0 ? 'prefix' : 'suffix';
            return Object.assign(Object.assign({}, resolvedOptions), { groupDelimiter,
                decimalDelimiter,
                currencySymbol,
                currencyPosition });
        }
        return Object.assign(Object.assign({}, resolvedOptions), { groupDelimiter, decimalDelimiter });
    };
}
function getPart(parts, name) {
    var _a;
    return (_a = parts.find((part) => part.type === name)) === null || _a === void 0 ? void 0 : _a.value;
}
