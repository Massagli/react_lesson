...
import { formatCurrency, formatCurrencyToParts, formatNumber, formatNumberToParts, resolveCurrencyFormat, resolveNumberFormat, } from '../index.js';
import { number } from './shared.js';
vi.mock('../intl', async () => {
    const intl = await vi.importActual('../intl');
    return Object.assign(Object.assign({}, intl), { isNumberFormatSupported: false, isNumberFormatToPartsSupported: false });
});
const locale = 'xx-XX';
describe('Numbers', () => {
