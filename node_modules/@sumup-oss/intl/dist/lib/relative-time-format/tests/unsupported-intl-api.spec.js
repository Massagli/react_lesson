...
import { formatRelativeTime, formatRelativeTimeToParts, resolveRelativeTimeFormat, } from '../index.js';
import { relativeTimes } from './shared.js';
vi.mock('../intl', async () => {
    const intl = await vi.importActual('../intl');
    return Object.assign(Object.assign({}, intl), { isRelativeTimeFormatSupported: false });
});
const locale = 'xx-XX';
describe('Relative times', () => {
    describe('when Intl.RelativeTimeFormat is unsupported', () => {
        it.each(relativeTimes)('should format %s %s as a relative time', (value, unit) => {
