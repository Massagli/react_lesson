...
var PostFinance24 = function PostFinance24(props) {
  ...
  if (
    ...
    console.warn(
      new Error(
        "The '".concat(
          size,
          "' size is not supported by the 'PostFinance' icon. Please use one of the available sizes: '24'.",
        ),
      ),
    );
  }
