...
var History24 = function History24(props) {
  ...
  if (
    ...
    console.warn(
      new Error(
        "The '".concat(
          size,
          "' size is not supported by the 'History' icon. Please use one of the available sizes: '24'.",
        ),
      ),
    );
  }
