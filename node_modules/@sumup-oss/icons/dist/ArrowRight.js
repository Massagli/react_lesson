...
var ArrowRight16 = function ArrowRight16(props) {
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement("path", {
      fillRule: "evenodd",
      clipRule: "evenodd",
      d: "M8.293 1.293a1 1 0 0 1 1.414 0l6 6a1 1 0 0 1 0 1.414l-6 6a1 1 0 0 1-1.414-1.414L12.586 9H1a1 1 0 1 1 0-2h11.586L8.293 2.707a1 1 0 0 1 0-1.414z",
      fill: "currentColor",
    }),
  );
};
...
export function ArrowRight(_ref) {
  let { size = "24" } = _ref,
  ...
  if (
    ...
    console.warn(
      new Error(
        "The '".concat(
          size,
          "' size is not supported by the 'ArrowRight' icon. Please use one of the available sizes: '16', '24'.",
        ),
      ),
    );
  }
