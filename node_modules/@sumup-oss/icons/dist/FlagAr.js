...
var FlagAr16 = function FlagAr16(props) {
  ...
  if (
    ...
    console.warn(
      new Error(
        "The '".concat(
          size,
          "' size is not supported by the 'FlagAr' icon. Please use one of the available sizes: '16'.",
        ),
      ),
    );
  }
