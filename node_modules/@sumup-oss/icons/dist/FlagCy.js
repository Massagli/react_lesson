...
var FlagCy16 = function FlagCy16(props) {
  ...
  if (
    ...
    console.warn(
      new Error(
        "The '".concat(
          size,
          "' size is not supported by the 'FlagCy' icon. Please use one of the available sizes: '16'.",
        ),
      ),
    );
  }
