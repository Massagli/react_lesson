...
var SamsungPay24 = function SamsungPay24(props) {
  ...
  if (
    ...
    console.warn(
      new Error(
        "The '".concat(
          size,
          "' size is not supported by the 'SamsungPay' icon. Please use one of the available sizes: '24'.",
        ),
      ),
    );
  }
