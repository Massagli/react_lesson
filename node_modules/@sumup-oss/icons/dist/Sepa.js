...
var Sepa24 = function Sepa24(props) {
  ...
  if (
    ...
    console.warn(
      new Error(
        "The '".concat(
          size,
          "' size is not supported by the 'Sepa' icon. Please use one of the available sizes: '24'.",
        ),
      ),
    );
  }
