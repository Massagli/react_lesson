...
var ReceiptMissing24 = function ReceiptMissing24(props) {
...
export function ReceiptMissing(_ref) {
  let { size = "24" } = _ref,
  ...
  if (
    ...
    console.warn(
      new Error(
        "The '".concat(
          size,
          "' size is not supported by the 'ReceiptMissing' icon. Please use one of the available sizes: '24'.",
        ),
      ),
    );
  }
