...
var Przelewy2424 = function Przelewy2424(props) {
  ...
  if (
    ...
    console.warn(
      new Error(
        "The '".concat(
          size,
          "' size is not supported by the 'Przelewy24' icon. Please use one of the available sizes: '24'.",
        ),
      ),
    );
  }
