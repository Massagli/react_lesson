...
var Info16 = function Info16(props) {
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement("path", {
      d: "M8 16A8 8 0 1 0 8-.001 8 8 0 0 0 8 16zm1-5a1 1 0 1 1-2 0V8a1 1 0 0 1 2 0v3zM8 3.5A1.25 1.25 0 1 1 8 6a1.25 1.25 0 0 1 0-2.5z",
      fill: "currentColor",
    }),
  );
};
  ...
  if (
    ...
    console.warn(
      new Error(
        "The '".concat(
          size,
          "' size is not supported by the 'Info' icon. Please use one of the available sizes: '16', '24'.",
        ),
      ),
    );
  }
