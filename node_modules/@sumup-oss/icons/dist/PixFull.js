...
var PixFull24 = function PixFull24(props) {
  ...
  if (
    ...
    console.warn(
      new Error(
        "The '".concat(
          size,
          "' size is not supported by the 'PixFull' icon. Please use one of the available sizes: '24'.",
        ),
      ),
    );
  }
