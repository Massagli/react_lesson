...
var CardIn24 = function CardIn24(props) {
  ...
  if (
    ...
    console.warn(
      new Error(
        "The '".concat(
          size,
          "' size is not supported by the 'CardIn' icon. Please use one of the available sizes: '24'.",
        ),
      ),
    );
  }
