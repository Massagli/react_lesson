...
var ArrowLeft16 = function ArrowLeft16(props) {
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement("path", {
      fillRule: "evenodd",
      clipRule: "evenodd",
      d: "M7.707 1.293a1 1 0 0 1 0 1.414L3.414 7H15a1 1 0 1 1 0 2H3.414l4.293 4.293a1 1 0 1 1-1.414 1.414l-6-6a1 1 0 0 1 0-1.414l6-6a1 1 0 0 1 1.414 0z",
      fill: "currentColor",
    }),
  );
};
...
export function ArrowLeft(_ref) {
  let { size = "24" } = _ref,
  ...
  if (
    ...
    console.warn(
      new Error(
        "The '".concat(
          size,
          "' size is not supported by the 'ArrowLeft' icon. Please use one of the available sizes: '16', '24'.",
        ),
      ),
    );
  }
