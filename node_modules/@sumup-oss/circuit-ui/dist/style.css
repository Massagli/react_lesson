...
.cui-buttons-button-list-uzak .cui-buttons-button-1b0s {
  margin-left: var(--cui-spacings-byte);
}

.cui-buttons-button-list-uzak .cui-buttons-button-1b0s:first-of-type {
  margin-left: 0;
}
.cui-button-ylou {
  position: relative;
...
.cui-button-primary-y79g[disabled],
.cui-button-primary-y79g[aria-disabled="true"] {
  color: var(--cui-fg-normal-disabled);
  background-color: var(--cui-bg-highlight-disabled);
  border-color: transparent;
}

.cui-button-primary-y79g.cui-button-destructive-os0y:disabled,
.cui-button-primary-y79g.cui-button-destructive-os0y[disabled],
.cui-button-primary-y79g.cui-button-destructive-os0y[aria-disabled="true"] {
...
.cui-button-secondary-owsx:disabled,
.cui-button-secondary-owsx[disabled],
.cui-button-secondary-owsx[aria-disabled="true"] {
  color: var(--cui-fg-normal-disabled);
  background-color: var(--cui-bg-normal);
  border-color: var(--cui-border-normal-disabled);
}

.cui-button-secondary-owsx.cui-button-destructive-os0y:disabled,
.cui-button-secondary-owsx.cui-button-destructive-os0y[disabled],
.cui-button-secondary-owsx.cui-button-destructive-os0y[aria-disabled="true"] {
  color: var(--cui-fg-danger-disabled);
  background-color: var(--cui-bg-normal);
  border-color: var(--cui-border-normal-disabled);
}
...
.cui-button-tertiary-s4ao:disabled,
.cui-button-tertiary-s4ao[disabled],
.cui-button-tertiary-s4ao[aria-disabled="true"] {
  color: var(--cui-fg-normal-disabled);
  background-color: transparent;
  border-color: transparent;
}

.cui-button-tertiary-s4ao.cui-button-destructive-os0y:disabled,
.cui-button-tertiary-s4ao.cui-button-destructive-os0y[disabled],
.cui-button-tertiary-s4ao.cui-button-destructive-os0y[aria-disabled="true"] {
  color: var(--cui-fg-danger-disabled);
}
...
.cui-body-o5xe strong {
  font-weight: var(--cui-font-weight-semibold);
}

.cui-body-quote-tpvn,
blockquote.cui-body-o5xe,
.cui-body-o5xe blockquote {
...
.cui-select-7zcb:disabled ~ .cui-select-icon-8yjr,
.cui-select-7zcb[disabled] ~ .cui-select-icon-8yjr {
  color: var(--cui-fg-subtle-disabled);
}
.cui-field-fieldset-bb62 {
  padding: 0;
  margin: 0;
  border: none;
}
...
.cui-tierindicator-loyj {
  display: inline-block;
  line-height: 0;
}
.cui-tableheader-datl {
  display: flex;
  flex-direction: column;
  align-items: center;
...
.cui-tableheader-wrapper-4kb6 {
  padding: 0;
  vertical-align: bottom;
}

.cui-tableheader-title-dgyd {
  display: flex;
...
.cui-tableheader-description-nupr {
  margin-top: var(--cui-spacings-bit);
}

.cui-tableheader-action-h7g0 {
  display: none;
  margin-top: var(--cui-spacings-mega);
}

.cui-tableheader-hide-tsni {
  display: none;
}
...
.cui-button-tertiary-qgem.cui-button-s-yzpu,
.cui-button-tertiary-qgem.cui-button-m-9sec {
  padding-right: 0;
  padding-left: 0;
}
.cui-rowheader-mq4z {
...
.cui-rowheader-description-bqfd {
  margin-top: var(--cui-spacings-bit);
  text-align: start;
}

@media (min-width: 768px) {
  .cui-rowheader-name-kpir {
    font-size: var(--cui-compact-m-font-size);
    line-height: var(--cui-compact-m-line-height);
  }
}
...
/* Table headers */
.cui-plantable-table-aopa thead th,
.cui-plantable-table-aopa thead td {
  position: sticky;
  top: 0;
  z-index: 1;
...
.cui-plantable-border-x2dy > div {
  border-left: 1px solid var(--cui-border-subtle);
}

.cui-plantable-section-vsgl {
  position: sticky;
  top: 0;
  z-index: 1;
...
.cui-plantable-table-aopa tbody tr td:not(:nth-of-type(1)) {
...
@media (max-width: 767px) {
  ...
  .cui-plantable-table-aopa colgroup col {
    width: 40%;
  }

  .cui-plantable-table-aopa colgroup col:first-child {
    width: 40%;
  }

  .cui-plantable-title-vvq9 {
    font-size: var(--cui-compact-m-font-size);
    line-height: var(--cui-compact-m-line-height);
  }
}
...
.cui-comparisontable-izi3 {
  position: relative;
  background-color: var(--cui-bg-normal);
}

.cui-comparisontable-picker-pbnn {
  position: sticky;
  top: 0;
  z-index: 2;
}
...
.cui-list-l-bgvx ul:last-child,
.cui-list-l-bgvx ol:last-child {
  margin-bottom: 0;
}
...
.cui-list-m-xr1c ul:last-child,
.cui-list-m-xr1c ol:last-child {
  margin-bottom: 0;
}
...
.cui-list-s-equv ul:last-child,
.cui-list-s-equv ol:last-child {
  margin-bottom: 0;
}
.cui-checkboxinput-label-knxi {
  --checkbox-size: 20px;
...
.cui-checkboxinput-label-knxi::before,
.cui-checkboxinput-label-knxi svg {
  position: absolute;
  left: 0;
  box-sizing: border-box;
  display: block;
...
.cui-checkboxinput-label-knxi.cui-checkboxinput-center-8rlk::before,
.cui-checkboxinput-label-knxi.cui-checkboxinput-center-8rlk svg {
  top: 50%;
}

.cui-checkboxinput-label-knxi.cui-checkboxinput-start-n0z8::before,
.cui-checkboxinput-label-knxi.cui-checkboxinput-start-n0z8 svg {
...
.cui-checkboxinput-rbck:hover + .cui-checkboxinput-label-knxi::before {
  border-color: var(--cui-border-accent-hovered);
}

.cui-checkboxinput-rbck:focus + .cui-checkboxinput-label-knxi::before {
  outline: 0;
...
.cui-checkboxinput-rbck:focus:not(:focus-visible) + .cui-checkboxinput-label-knxi::before {
  border-color: var(--cui-border-normal);
  box-shadow: none;
}

.cui-checkboxinput-rbck:checked:focus:not(:focus-visible) + .cui-checkboxinput-label-knxi::before,
.cui-checkboxinput-rbck:indeterminate:focus:not(:focus-visible) + .cui-checkboxinput-label-knxi::before {
  border-color: var(--cui-border-accent);
}

.cui-checkboxinput-rbck:checked:not(:indeterminate) + .cui-checkboxinput-label-knxi > svg[data-symbol="checked"],
.cui-checkboxinput-rbck:indeterminate + .cui-checkboxinput-label-knxi > svg[data-symbol="indeterminate"] {
  opacity: 1;
  transform: translateY(-50%) scale(1, 1);
}

.cui-checkboxinput-rbck:checked + .cui-checkboxinput-label-knxi::before,
.cui-checkboxinput-rbck:indeterminate + .cui-checkboxinput-label-knxi::before {
  background-color: var(--cui-bg-accent-strong);
  border-color: var(--cui-border-accent);
}

.cui-checkboxinput-rbck:checked:disabled + .cui-checkboxinput-label-knxi::before,
.cui-checkboxinput-rbck:checked[disabled] + .cui-checkboxinput-label-knxi::before,
.cui-checkboxinput-rbck:indeterminate:disabled + .cui-checkboxinput-label-knxi::before,
.cui-checkboxinput-rbck:indeterminate[disabled] + .cui-checkboxinput-label-knxi::before {
...
.cui-checkboxinput-invalid-o7bt + .cui-checkboxinput-label-knxi::before {
  background-color: var(--cui-bg-danger);
  border-color: var(--cui-border-danger);
}

.cui-checkboxinput-invalid-o7bt:hover + .cui-checkboxinput-label-knxi::before,
.cui-checkboxinput-invalid-o7bt:focus + .cui-checkboxinput-label-knxi::before {
  border-color: var(--cui-border-danger-hovered);
}

.cui-checkboxinput-invalid-o7bt:checked + .cui-checkboxinput-label-knxi::before,
.cui-checkboxinput-invalid-o7bt:indeterminate + .cui-checkboxinput-label-knxi::before {
  background-color: var(--cui-bg-danger-strong);
  border-color: var(--cui-border-danger);
}

.cui-checkboxinput-invalid-o7bt:checked:disabled + .cui-checkboxinput-label-knxi::before,
.cui-checkboxinput-invalid-o7bt:indeterminate:disabled + .cui-checkboxinput-label-knxi::before,
.cui-checkboxinput-invalid-o7bt:checked[disabled] + .cui-checkboxinput-label-knxi::before,
.cui-checkboxinput-invalid-o7bt:indeterminate[disabled] + .cui-checkboxinput-label-knxi::before {
...
.cui-checkboxinput-rbck:disabled + .cui-checkboxinput-label-knxi,
.cui-checkboxinput-rbck[disabled] + .cui-checkboxinput-label-knxi {
  color: var(--cui-fg-normal-disabled);
  pointer-events: none;
}

.cui-checkboxinput-rbck:disabled + .cui-checkboxinput-label-knxi::before,
.cui-checkboxinput-rbck[disabled] + .cui-checkboxinput-label-knxi::before {
  background-color: var(--cui-bg-normal-disabled);
  border-color: var(--cui-border-normal-disabled);
}

.cui-checkboxinput-rbck:disabled:checked + .cui-checkboxinput-label-knxi::before,
.cui-checkboxinput-rbck[disabled]:checked + .cui-checkboxinput-label-knxi::before {
  background-color: var(--cui-bg-accent-strong-disabled);
  border-color: var(--cui-border-accent-disabled);
}
...
.cui-radiobuttoninput-label-mkor {
...
.cui-radiobuttoninput-label-mkor::before,
.cui-radiobuttoninput-label-mkor::after {
  position: absolute;
  box-sizing: border-box;
  display: block;
  content: "";
...
.cui-radiobuttoninput-label-mkor.cui-radiobuttoninput-start-fcez::before,
.cui-radiobuttoninput-label-mkor.cui-radiobuttoninput-start-fcez::after {
  top: calc(var(--cui-body-m-line-height) / 2);
}
...
.cui-radiobuttoninput-ptqk:hover + .cui-radiobuttoninput-label-mkor::before {
  border-color: var(--cui-border-normal-hovered);
}

.cui-radiobuttoninput-ptqk:focus + .cui-radiobuttoninput-label-mkor::before {
  outline: 0;
  border-color: var(--cui-border-accent);
  box-shadow:
    0 0 0 2px var(--cui-bg-normal),
...
.cui-radiobuttoninput-ptqk:focus:not(:focus-visible) + .cui-radiobuttoninput-label-mkor::before {
  border-color: var(--cui-border-normal);
  box-shadow: none;
}

.cui-radiobuttoninput-ptqk:checked:focus:not(:focus-visible) + .cui-radiobuttoninput-label-mkor::before {
  border-color: var(--cui-border-accent);
}

.cui-radiobuttoninput-ptqk:checked + .cui-radiobuttoninput-label-mkor::before {
  border-color: var(--cui-border-accent);
}

.cui-radiobuttoninput-ptqk:checked + .cui-radiobuttoninput-label-mkor::after {
  opacity: 1;
  transform: translateY(-50%) scale(1, 1);
}

.cui-radiobuttoninput-ptqk:disabled + .cui-radiobuttoninput-label-mkor,
.cui-radiobuttoninput-ptqk[disabled] + .cui-radiobuttoninput-label-mkor {
  color: var(--cui-fg-normal-disabled);
  pointer-events: none;
}

.cui-radiobuttoninput-ptqk:disabled + .cui-radiobuttoninput-label-mkor::before,
.cui-radiobuttoninput-ptqk[disabled] + .cui-radiobuttoninput-label-mkor::before {
  background-color: var(--cui-bg-normal-disabled);
  border-color: var(--cui-border-normal-disabled);
}

.cui-radiobuttoninput-ptqk:disabled + .cui-radiobuttoninput-label-mkor::after,
.cui-radiobuttoninput-ptqk[disabled] + .cui-radiobuttoninput-label-mkor::after {
  background-color: var(--cui-fg-on-strong-disabled);
}

.cui-radiobuttoninput-ptqk:disabled:checked + .cui-radiobuttoninput-label-mkor::before,
.cui-radiobuttoninput-ptqk[disabled]:checked + .cui-radiobuttoninput-label-mkor::before {
  border-color: var(--cui-border-accent-disabled);
}

.cui-radiobuttoninput-ptqk:disabled:checked + .cui-radiobuttoninput-label-mkor::after,
.cui-radiobuttoninput-ptqk[disabled]:checked + .cui-radiobuttoninput-label-mkor::after {
...
[aria-invalid="true"] .cui-radiobuttoninput-ptqk:not(:focus) + .cui-radiobuttoninput-label-mkor::before {
  background-color: var(--cui-bg-danger);
  border-color: var(--cui-border-danger);
}

[aria-invalid="true"] .cui-radiobuttoninput-ptqk:not(:focus) + .cui-radiobuttoninput-label-mkor::after {
  background-color: var(--cui-fg-danger);
}

[aria-invalid="true"] .cui-radiobuttoninput-ptqk:hover + .cui-radiobuttoninput-label-mkor::before,
[aria-invalid="true"] .cui-radiobuttoninput-ptqk:focus + .cui-radiobuttoninput-label-mkor::before {
  border-color: var(--cui-border-danger-hovered);
}

[aria-invalid="true"] .cui-radiobuttoninput-ptqk:checked + .cui-radiobuttoninput-label-mkor::before {
  border-color: var(--cui-border-danger);
}
.cui-radiobutton-label-text-ahll {
  display: inline-block;
  padding-left: var(--cui-spacings-byte);
}
.cui-radiobuttongroup-c66x {
  display: flex;
  flex-direction: column;
  gap: var(--cui-spacings-bit);
}
...
.cui-calendar-selected-rs7l,
[aria-pressed="true"].cui-calendar-range-start-5hcq,
[aria-pressed="true"].cui-calendar-range-end-4p8d {
  font-weight: var(--cui-font-weight-bold);
  color: var(--cui-fg-on-strong);
  background: var(--cui-bg-accent-strong);
}

.cui-calendar-selected-rs7l:hover,
[aria-pressed="true"].cui-calendar-range-start-5hcq:hover,
[aria-pressed="true"].cui-calendar-range-end-4p8d:hover {
  background: var(--cui-bg-accent-strong-hovered);
}

.cui-calendar-selected-rs7l:active,
.cui-calendar-range-start-5hcq:active,
.cui-calendar-range-end-4p8d:active {
...
td:not(:last-of-type) .cui-calendar-range-start-5hcq.cui-calendar-first-day-jox5::before,
td:not(:last-of-type) .cui-calendar-range-middle-b5tg.cui-calendar-first-day-jox5::before,
td:not(:last-of-type) .cui-calendar-range-end-4p8d.cui-calendar-first-day-jox5::before {
  background: linear-gradient(to left, var(--cui-bg-accent) 75%, transparent);
}

td:not(:last-of-type) .cui-calendar-range-start-5hcq.cui-calendar-last-day-djsc::before,
td:not(:last-of-type) .cui-calendar-range-middle-b5tg.cui-calendar-last-day-djsc::before,
td:not(:last-of-type) .cui-calendar-range-end-4p8d.cui-calendar-last-day-djsc::before {
...
.cui-calendar-day-5jmq[aria-disabled="true"]:hover,
.cui-calendar-day-5jmq[aria-disabled="true"]:active {
...
.cui-calendar-day-5jmq[aria-disabled="true"].cui-calendar-selected-rs7l,
.cui-calendar-day-5jmq[aria-disabled="true"].cui-calendar-range-start-5hcq,
.cui-calendar-day-5jmq[aria-disabled="true"].cui-calendar-range-end-4p8d {
  color: var(--cui-fg-on-strong-disabled);
  background: var(--cui-bg-accent-strong-disabled);
}

.cui-calendar-day-5jmq[aria-disabled="true"].cui-calendar-range-start-5hcq::before,
.cui-calendar-day-5jmq[aria-disabled="true"].cui-calendar-range-middle-b5tg::before,
.cui-calendar-day-5jmq[aria-disabled="true"].cui-calendar-range-end-4p8d::before {
...
.cui-datesegment-kkaf::-webkit-outer-spin-button,
.cui-datesegment-kkaf::-webkit-inner-spin-button {
  margin: 0;
  appearance: none;
}
...
.cui-dateinput-calendar-button-ljnt:active,
.cui-dateinput-calendar-button-ljnt[aria-expanded="true"] {
  z-index: calc(var(--cui-z-index-absolute) + 1);
}
...
.cui-percentageinput-symbol-izcv {
  display: flex;
  align-items: center;
  justify-content: center;
  line-height: var(--cui-spacings-mega);
...
@media (max-width: 479px) {
  ...
  .cui-phonenumberinput-country-code-whzt.cui-phonenumberinput-country-code-whzt select,
...
.cui-phonenumberinput-country-code-whzt.cui-phonenumberinput-country-code-whzt:hover,
.cui-phonenumberinput-country-code-whzt.cui-phonenumberinput-country-code-whzt:focus,
.cui-phonenumberinput-country-code-input-js8d.cui-phonenumberinput-country-code-input-js8d:hover,
...
svg:has(+ .cui-phonenumberinput-country-code-whzt:hover),
svg:has(+ .cui-phonenumberinput-country-code-whzt:focus) {
  z-index: calc(var(--cui-z-index-input) + 3);
}
...
.cui-colorinput-input-ijxl:hover,
.cui-colorinput-input-ijxl:focus {
  z-index: var(--cui-z-index-absolute);
}
...
.cui-carouselpagination-cue-13ci {
  display: block;
...
a.cui-carouselpagination-cue-13ci,
button.cui-carouselpagination-cue-13ci {
  cursor: pointer;
}

.cui-carouselpagination-shape-nvqz {
  display: block;
...
a.cui-carouselpagination-cue-13ci:hover .cui-carouselpagination-shape-nvqz,
button.cui-carouselpagination-cue-13ci:hover .cui-carouselpagination-shape-nvqz {
  background-color: var(--cui-fg-placeholder-hovered);
}

a.cui-carouselpagination-cue-13ci:active .cui-carouselpagination-shape-nvqz,
button.cui-carouselpagination-cue-13ci:active .cui-carouselpagination-shape-nvqz {
  background-color: var(--cui-fg-placeholder-pressed);
}

.cui-carouselpagination-cue-13ci[aria-current] .cui-carouselpagination-shape-nvqz {
  width: var(--cui-spacings-peta);
  background-color: var(--cui-bg-strong);
}

a.cui-carouselpagination-cue-13ci[aria-current]:hover .cui-carouselpagination-shape-nvqz,
button.cui-carouselpagination-cue-13ci[aria-current]:hover .cui-carouselpagination-shape-nvqz {
  background-color: var(--cui-bg-strong-hovered);
}

a.cui-carouselpagination-cue-13ci[aria-current]:active .cui-carouselpagination-shape-nvqz,
button.cui-carouselpagination-cue-13ci[aria-current]:active .cui-carouselpagination-shape-nvqz {
...
.cui-tooltip-rres[data-state="open"],
.cui-tooltip-rres:hover,
.cui-tooltip-component-ccnn:hover + .cui-tooltip-rres,
.cui-tooltip-component-ccnn:focus-visible + .cui-tooltip-rres {
  pointer-events: auto;
  opacity: 1;
  transition-delay: 1s;
}
...
.cui-tooltip-rres,
.cui-tooltip-rres[data-state="closed"]:hover,
.cui-tooltip-component-ccnn:hover + .cui-tooltip-rres[data-state="closed"],
.cui-tooltip-component-ccnn:focus-visible + .cui-tooltip-rres[data-state="closed"] {
  transition-delay: 0s;
}
