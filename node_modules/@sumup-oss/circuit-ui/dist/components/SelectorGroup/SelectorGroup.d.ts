...
import { type SelectorProps, type SelectorSize } from '../Selector/Selector.js';
export interface SelectorGroupProps extends Omit<FieldsetHTMLAttributes<HTMLFieldSetElement>, 'onChange' | 'onBlur'> {
    /**
 ...
 */
export declare const SelectorGroup: import("react").ForwardRefExoticComponent<SelectorGroupProps & import("react").RefAttributes<HTMLFieldSetElement>>;
