...
type Options = Omit<CheckboxProps, 'onChange' | 'validationHint' | 'name' | 'value' | 'optionalLabel'> & {
    value: string | number;
};
export interface CheckboxGroupProps extends Omit<FieldsetHTMLAttributes<HTMLFieldSetElement>, 'onChange' | 'onBlur' | 'defaultValue'> {
    /**
 ...
 */
export declare const CheckboxGroup: import("react").ForwardRefExoticComponent<Omit<CheckboxGroupProps, "ref"> & import("react").RefAttributes<HTMLFieldSetElement>>;
export {};
