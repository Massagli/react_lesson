...
export interface CompactProps extends HTMLAttributes<HTMLParagraphElement> {
     ...
     */
    color?: 'normal' | 'subtle' | 'placeholder' | 'on-strong' | 'on-strong-subtle' | 'accent' | 'success' | 'warning' | 'danger' | 'promo';
    /**
 ...
 * to our users.
 */
export declare const Compact: import("react").ForwardRefExoticComponent<CompactProps & import("react").RefAttributes<HTMLParagraphElement>>;
