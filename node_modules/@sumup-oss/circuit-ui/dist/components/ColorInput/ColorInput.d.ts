...
export interface ColorInputProps extends Omit<InputProps, 'ref' | 'type' | 'defaultValue' | 'value' | 'placeholder' | 'maxLength' | 'pattern' | 'renderPrefix' | 'as' | 'textAlign' | 'renderSuffix'> {
    /**
