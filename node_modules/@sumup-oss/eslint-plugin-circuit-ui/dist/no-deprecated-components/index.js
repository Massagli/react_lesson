...
exports.noDeprecatedComponents = void 0;
...
exports.noDeprecatedComponents = createRule({
    ...
    create(context) {
        return {
            'ImportDeclaration:has(Literal[value="@sumup-oss/circuit-ui"])': (node) => {
                node.specifiers.forEach((specifier) => {
                    if (specifier.type !== 'ImportSpecifier') {
                        return;
                    }
                    const component = components.find(({ name }) => name === specifier.imported.name);
                    if (!component) {
                        return;
                    }
                    context.report({
