...
exports.noInvalidCustomProperties = void 0;
const utils_1 = require("@typescript-eslint/utils");
const design_tokens_1 = require("@sumup-oss/design-tokens");
const PREFIX = '--cui-';
const VALID_CUSTOM_PROPERTIES_WITHOUT_PREFIX = design_tokens_1.schema.map(({ name }) => name.replace(PREFIX, ''));
const REGEX_STRING = `(?:${PREFIX})(?!(?:${VALID_CUSTOM_PROPERTIES_WITHOUT_PREFIX.join('|')})[^\\w-])[\\w-]+`;
/* eslint-disable */
...
exports.noInvalidCustomProperties = createRule({
